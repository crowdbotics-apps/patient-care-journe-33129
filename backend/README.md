...
## Project Structure
    ...
    ├── patient_care_journe_33129  # Django project configurations
...
1. Clone this repo and `cd patient_care_journe_33129`
...
2. Clone this repo and `cd patient_care_journe_33129`
